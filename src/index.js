  ...
  render() {
      ...
      <Band>
        <HeadElement>
          ...
          <Active>
            ...
            <i style={{ cursor: "pointer" }} className="fa fa-angle-down"></i>
          </Active>
        </HeadElement>
        <SortBy>
          <Sort> Sort by</Sort> Last Updated{" "}
          <i
    ...
    const detailBand = (
      <JobBand>
        ...
        <FilterDetails>
          <Box style={{ margin: "0px", borderRadius: "3px 0px 0px 3px" }}>
            Add candidates
          </Box>
          <Box style={{ margin: "0px", borderRadius: "0px 3px 3px 0px" }}>
            <i className="fa fa-angle-down" style={{ margin: "4px" }}></i>
          </Box>
          <Box
            style={{
              margin: "0px 12px",
              backgroundColor: "#46467c",
              color: "#fff",
            }}
          >
            <i style={{ margin: "4px" }} className="fa-solid fa-globe"></i>
            Published
            <i style={{ margin: "4px" }} className="fa fa-angle-down"></i>
          </Box>
        </FilterDetails>
      </JobBand>
    );
    ...
    const TalentCenterBand = (
      <JobBand style={{ backgroundColor: "#fff", alignItems: "center" }}>
        <HeadElement style={{ backgroundColor: "#fff" }}>
          ...
          <h2 style={{ fontWeight: "normal" }}> iamneo.ai Talent Center</h2>
        </HeadElement>
        <FilterDetails style={{ alignItems: "center" }}>
          ...
          >
            <i style={{ margin: "4px" }} className="fa-solid fa-plus"></i>
            Add New
          </Box>
          <i style={{ fontSize: "20px" }} className="fa-solid fa-gift"></i>
          <Circle> S </Circle>
        </FilterDetails>
      </JobBand>
    );
      ...
      <SideBands>
        ...
        <Buttons>
          <TopButton>
            ...
            <i
              style={{ cursor: "pointer", background: "#9c42c4" }}
              className="fa-solid fa-briefcase"
            ></i>
            <i
              style={{ cursor: "pointer" }}
            ...
            ></i>
            <i style={{ cursor: "pointer" }} className="fa-solid fa-gear"></i>
          </TopButton>
          <BottomButton>
            {" "}
            <i
            ...
            ></i>
            <i style={{ cursor: "pointer" }} className="fa-solid fa-grip"></i>
          </BottomButton>
        </Buttons>
      </SideBands>
    );
